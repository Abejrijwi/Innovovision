                                ...
                                <tbody>
                                    ...
                                    foreach ($userlist as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value->utype ?></td>
                                            <td>
                                                <span class="<?php echo $value->locked == 1 ? 'label label-danger' : 'label label-primary'; ?>"><?php echo $value->locked == 1 ? 'Disabled' : 'Active'; ?></span>
                                            </td>                                            
                                            <td class="text-center">
                                                <div role="group" aria-label="Basic example" class="btn-group btn-group-sm">
                                                    <button type="button" class="btn btn-raised btn-warning"><i class="ti-eye"></i></button>
                                                    <a href="<?php echo site_url('welcome/edit_user') . "/" . $value->id ?>" class="btn btn-raised btn-primary"><i class="ti-pencil"></i></a>
                                                    <button type="button" class="btn btn-raised btn-danger" data-toggle="modal" data-target="#confirm-modal<?php echo $value->id; ?>"><i class="ti-trash"></i></button>
                                                </div>
                                            </td>
                                        </tr>
